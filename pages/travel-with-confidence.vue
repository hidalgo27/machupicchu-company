  ...
  <section class="container mt-12">
    ...
    <div class="grid grid-cols-1 md:grid-cols-5 border mb-6">
      ...
      <div class="col-span-3 p-12">
        ...
        <p class="text-gray-500 dark:text-gray-200 text-sm">These measures have been developed in alignment with government recommendations and health providers across our destinations. For example, GOTOECUADOR has implemented the World Travel & Tourism Council’s “Safe Travels” protocols and the Ecuatorian Tourist Board’s “Clean & Safe” norms.</p>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-5 border mb-6">
      ...
      <div class="col-span-3 p-12">
        ...
        <p class="text-gray-500 dark:text-gray-200 text-sm">Our GOTOECUADOR travel agents select the hotels for their quality, location and high service standards. In addition, we are working with our hotel partners to ensure that they also meet our health and hygiene requirements.</p>
    ...
    <div class="grid grid-cols-1 md:grid-cols-5 border mb-6">
      ...
      <div class="col-span-3 p-12">
        ...
        <p class="text-gray-500 dark:text-gray-200 text-sm">Ecuador is known for its exquisite gastronomy and with more reason we will offer you the best recommendations to enjoy the best plates at the best places.</p>
        <p class="text-gray-500 dark:text-gray-200 text-sm">We also certify that our experienced providers for every activity are aligned with us when it comes to health and hygiene procedures; all the Ecuatorian activities offered are tested and are selected for you.</p>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-5 border mb-6">
      ...
      <div class="col-span-3 p-12">
        ...
        <p class="text-gray-500 dark:text-gray-200 text-sm">GOTOECUADOR best local guides. They will be there to keep you safe and create an unforgettable Peru vacation from start to finish.</p>
    ...
    <div class="grid grid-cols-1 md:grid-cols-5 border mb-6">
      ...
      <div class="col-span-3 p-12">
        ...
        <p class="text-gray-500 dark:text-gray-200 text-sm">Part of the GOTOECUADOR experience will be to have all comprehensiva travel documents and useful information before arrival and in addition your travel advisor will keep you updated should any changes arise.</p>
        <p class="text-gray-500 dark:text-gray-200 text-sm">Your Ecuador travel documents will have all the information you need in one place to help you prepare and maximize your Ecuatorian adventure plus our tips based on many years of experience.</p>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-5 border mb-6">
      ...
      <div class="col-span-3 p-12">
        ...
        <p class="text-gray-500 dark:text-gray-200 text-sm">Our Headquarters are located in Cusco but we have remote offices in Arequipa, Lima and Puno, plus GOTOECUADOR representatives in MachuPicchu, Nazca, Paracas, Urubamba, Puerto Maldonado and Chiclayo.</p>
      </div>
    </div>
